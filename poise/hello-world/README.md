# Poise Hello World Bot with Cyndra

In this example we will deploy a Poise/Serenity bot with Cyndra that responds to the `/hello` command with `world!`. To run this bot we need a valid Discord Token. To get started log in to the [Discord developer portal](https://discord.com/developers/applications).
