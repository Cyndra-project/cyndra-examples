Example of how you can compile Bevy to WASM and run it on Cyndra.
...
Go to the project workspace root or the `server` folder, run `cargo cyndra run`, then visit `http://localhost:8000/game`, you should see your Bevy program in action!
