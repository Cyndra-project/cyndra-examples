...
Axum | [htmx-crud](./axum/htmx-crud/) | htmx CRUD app | `cargo cyndra init --from cyndra-hq/cyndra-examples --subfolder axum/htmx-crud`
...
Axum | [jwt-authentication](./axum/jwt-authentication/) | Use JWT to authenticate API endpoints | `cargo cyndra init --from cyndra-hq/cyndra-examples --subfolder axum/jwt-authentication`
...
Loco | [hello-world](./loco/hello-world/) | Hello World | `cargo cyndra init --template loco`
...
Rocket | [jwt-authentication](./rocket/jwt-authentication/) | Use JWT to authenticate API endpoints | `cargo cyndra init --from cyndra-hq/cyndra-examples --subfolder rocket/jwt-authentication`
...
**Framework** | **Name & Link** | **Description** | **Command**
--------------|-----------------|-------------|----------------
Actix Web/Any | [GitHub Login (OAuth)](https://github.com/robjtede/actix-examples-oauth-github) | Sample app demonstrating GitHub OAuth login using Actix Web | `cargo cyndra init --from robjtede/actix-examples-oauth-github`
...
Axum/Bevy | [Cyndra with Bevy](https://github.com/joshua-mo-143/cyndra-bevy-ex) | A basic project template for a compiled Bevy WASM "Hello World" webpage | `cargo cyndra init --from joshua-mo-143/cyndra-bevy-ex` |
...
Rocket/Yew | [Web API with Rocket and Sled](https://github.com/wiseaidev/rocket-yew-starter-pack) | A Full Stack CRUD template for starting an API with [Rocket](https://github.com/rwf2/Rocket), [Sled](https://github.com/spacejam/sled) and [Yew](https://github.com/yewstack/yew) | `cargo cyndra init --from wiseaidev/rocket-yew-starter-pack`
