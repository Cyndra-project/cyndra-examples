...
const cards = [
  {
    title: 'Deployed from Cyndra',
    description: 'Deployed via Cyndra, a Rust-native cloud dev platform.',
    href: 'https://www.cyndra.rs',
  },
  {
  ...
  },
  {
    ...
    href: 'https://discord.com/invite/cyndra',
  },
];
    ...
    <>
      <Layout>
        <section className="min-h-full py-40 w-full flex flex-col justify-center items-center gap-10">
          ...
          <p className="text-xs">
            Powered by{' '}
            <a className="font-semibold" href="https://cyndra.rs" target="_blank">
              🚀 Cyndra
            </a>
          </p>
        </section>
